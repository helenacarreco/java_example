...
<div class="container" align="center">
	<div class="col-md-6">
		...
		<h5>Alteração de anotação - <c:out value="${tipo}" /></h5>
		...
		<form class="form-signin" method="post">
			<div class="form-group" align="left">
				...
				<textarea id="anotacao" name="anotacao" class="md-textarea form-control" rows="5" maxlength="200" autofocus><c:out value="${anotacao}" /></textarea>
			</div>
